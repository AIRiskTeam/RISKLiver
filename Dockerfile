...
RUN apt-get update && \
apt-get install -y curl tar bzip2 libgomp1 libxrender1 libxext6 libexpat1 libxt6 unzip xz-utils && \
...
echo "/usr/OPERA/application" > /root/.mcrCache9.12/OPERA_0/OPERA_installdir.txt && \
cd /root && \
